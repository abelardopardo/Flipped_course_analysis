...
head(sorted.traces)
colnames(sorted.traces)[1] <- "STUDENT_ID"
...
## check the distribution of events across the course weeks
table(sorted.traces$WEEK)
weekly.props <- as.matrix(round(prop.table(table(sorted.traces$WEEK)), digits = 3))
kable(t(weekly.props), format = "pandoc")
...
# 6 students have less than 10 sessions 
...
# 10.00   49.00   74.00   81.54  104.20  384.00  
## check for outliers
...
# 480 (the initial number of students = 486)
## and how many sessions
length(unique(sorted.traces$SESSION_ID))
# 39141 (initially, 39159)
...
result <- fit.and.save.hmm(w.features, ns = 4, week = 2)
summary(result)
...
result <- fit.and.save.hmm(w.features, ns = 6, week = 3)
summary(result)
...
## fit model with 4 states (alternative: ns=6)
result <- fit.and.save.hmm(w.features, ns = 4, week = 5)
summary(result)
...
result <- fit.and.save.hmm(w.features, ns = 5, week = 6)
summary(result)
...
## fit model with 6 states 
result <- fit.and.save.hmm(w.features, ns = 6, week = 7)
summary(result)
...
## fit model with 6 states
result <- fit.and.save.hmm(w.features, ns = 6, week = 8)
summary(result)
...
## fit model with 4 states (alternative: ns=6)
result <- fit.and.save.hmm(w.features, ns = 4, week = 9)
summary(result)
...
## fit model with 4 states
result <- fit.and.save.hmm(w.features, ns = 4, week = 10)
summary(result)
...
## fit model with 6 states
result <- fit.and.save.hmm(w.features, ns = 6, week = 11)
summary(result)
...
## fit a model with 5 states 
result <- fit.and.save.hmm(w.features, ns = 5, week = 12)
summary(result)
...
## fit a model with 4 states (alternative: ns=6)
