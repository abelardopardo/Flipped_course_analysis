...
## f. for pair-wise comparisons of final exam scores using the Mann-Whitney U Test
...
## f. for pair-wise comparisons of midterm exam scores using the Mann-Whitney U Test
## FDR correction is used to avoid family-wise error 
